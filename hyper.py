...
def run(input_file: str, mode='mem', n_layer=2, n_head=4, d_model=512, d_k=4, d_hidden=1024, time_s=300, mag=0.125, adiv=10, pdiv=10, fixedpos='FromZero', layernorm='Affine', enorm='False', ldiv=3, n_batch=64, gamma=0.99, ratiolr='False', lr=0.003, epoch=10000, vsmall=0, save=False):
    output_file = f'data/'
